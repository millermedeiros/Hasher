...
(function(){
	 ...
	 */
	prot.addEventListener = function(eType, fn){
	 ...
	 * @param {Function} fn	Event Handler.
	 */
	prot.removeEventListener = function(eType, fn){
	 ...
	 */
	prot.removeAllEventListeners = function(){
		this._handlers = {};
	};
	 ...
	 * @return {Boolean}
	 */
	prot.hasEventListener = function(eType){
